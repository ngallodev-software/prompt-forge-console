...
Use this checklist to execute [frontend-unmocking-plan.md](/lump/apps/prompt-forge-console/docs/phased-impl/frontend-unmocking-plan.md).

Scope
- Frontend repo: `/lump/apps/prompt-forge-console`
...
- [ ] Remove mock fallback for features whose backend routes are stable.
  - File targets:
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
    - [src/services/promptforge/config.ts](/lump/apps/prompt-forge-console/src/services/promptforge/config.ts)
  - Done when:
...
- [ ] Keep bootstrap hydration as startup convenience, not source of truth.
  - File targets:
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
    - [src/services/promptforge/query-catalog.ts](/lump/apps/prompt-forge-console/src/services/promptforge/query-catalog.ts)
  - Done when:
...
- [ ] Verify query keys still align with backend responses.
  - File targets:
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
    - [src/services/promptforge/mutation-invalidation.ts](/lump/apps/prompt-forge-console/src/services/promptforge/mutation-invalidation.ts)
  - Done when:
...
- [ ] Replace `upsertTemplateLocal()` with real backend CRUD.
  - File targets:
    - [src/pages/Templates.tsx](/lump/apps/prompt-forge-console/src/pages/Templates.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
    - [src/services/promptforge/types.ts](/lump/apps/prompt-forge-console/src/services/promptforge/types.ts)
  - Done when:
...
- [ ] Enable rule creation against real backend endpoints.
  - File targets:
    - [src/pages/Rules.tsx](/lump/apps/prompt-forge-console/src/pages/Rules.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
    - [src/services/promptforge/types.ts](/lump/apps/prompt-forge-console/src/services/promptforge/types.ts)
  - Done when:
    - new rules persist
...
- [ ] Remove retry/reroute/status fallback once backend routes are stable.
  - File targets:
    - [src/pages/Deliveries.tsx](/lump/apps/prompt-forge-console/src/pages/Deliveries.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
  - Done when:
...
- [ ] Keep queue depth derived from server truth.
  - File targets:
    - [src/pages/Dashboard.tsx](/lump/apps/prompt-forge-console/src/pages/Dashboard.tsx)
    - [src/pages/Deliveries.tsx](/lump/apps/prompt-forge-console/src/pages/Deliveries.tsx)
  - Done when:
...
- [ ] Add real dispatch actions for supported targets.
  - File targets:
    - [src/pages/Targets.tsx](/lump/apps/prompt-forge-console/src/pages/Targets.tsx)
    - [src/services/promptforge/types.ts](/lump/apps/prompt-forge-console/src/services/promptforge/types.ts)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
  - Done when:
...
- [ ] Remove local mutation fallback for term upsert.
  - File targets:
    - [src/pages/Dictionary.tsx](/lump/apps/prompt-forge-console/src/pages/Dictionary.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
  - Done when:
...
- [ ] Replace clone / force-review / priority update fallback behavior with backend-only state.
  - File targets:
    - [src/pages/Prompts.tsx](/lump/apps/prompt-forge-console/src/pages/Prompts.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
  - Done when:
...
- [ ] Keep browser-only preferences in persisted app state.
  - File targets:
    - [src/stores/app-store.ts](/lump/apps/prompt-forge-console/src/stores/app-store.ts)
    - [src/pages/Settings.tsx](/lump/apps/prompt-forge-console/src/pages/Settings.tsx)
  - Done when:
...
- [ ] Prefer real backend aggregates over bootstrap-computed summaries.
  - File targets:
    - [src/pages/Dashboard.tsx](/lump/apps/prompt-forge-console/src/pages/Dashboard.tsx)
    - [src/pages/Health.tsx](/lump/apps/prompt-forge-console/src/pages/Health.tsx)
    - [src/pages/Logs.tsx](/lump/apps/prompt-forge-console/src/pages/Logs.tsx)
  - Done when:
...
- [ ] Keep lineage sourced from real backend endpoints.
  - File targets:
    - [src/pages/Pipeline.tsx](/lump/apps/prompt-forge-console/src/pages/Pipeline.tsx)
    - [src/pages/IntakeDetail.tsx](/lump/apps/prompt-forge-console/src/pages/IntakeDetail.tsx)
    - [src/services/promptforge/api.ts](/lump/apps/prompt-forge-console/src/services/promptforge/api.ts)
  - Done when:
...
- [ ] Keep review queue aligned with backend state.
  - File targets:
    - [src/pages/Review.tsx](/lump/apps/prompt-forge-console/src/pages/Review.tsx)
  - Done when:
